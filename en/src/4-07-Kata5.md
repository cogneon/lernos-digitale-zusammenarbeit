...
- **Main topic**: *(45 minutes)*
  ...
  stop?  
  (If you can't decide, just try this [template](\6-01-templates): 4L)  
...
- Consider together whether rules in the collaboration canvas should be
  adapted or expanded, if necessary, expand the [collaboration canvas](\5-01-Cooperation#Collaboration-Canvas) with your
...
- Take a look at the various tools and templates and discuss them with
  ...
  take a look at the [Retrospective theory](\5-03-Retrospective).

  - Example of a retro:

    **4L method**:  
    ![LIKED: What went really well? LEARNED: What did I learn? LACKED: What didn't I like? LONGED FOR: What did I miss?](images/Retrospektive-Template.png)  

    You can find a PowerPoint template for this under [template](\6-01-templates).
