...
rem "c:\Portable\pandoc-3.6.4\pandoc.exe" --from docx --to markdown "C:\Daten\Programmierung\GitHub\lernos-digitale-zusammenarbeit\en\2.0 lernOS-Digital-Collaboration-Guide_En.docx" -o "c:\Daten\Programmierung\GitHub\lernos-digitale-zusammenarbeit\en\lernOS_digitalCollaboration_Guide.md" --extract-media=".\src\imgnew"
